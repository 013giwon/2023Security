...
if __name__ == "__main__":
    ...
    parser.add_argument('-a', '--addr', type=str, default='127.0.0.1',
                        help='TCP addr.')
    parser.add_argument('-s', '--stride', type=str, default='21',
                        help='patch stride.')
    parser.add_argument('-ps', '--patch_size', type=str, default='21',
                        help='patch_size.')
    parser.add_argument('-f', '--file_name', type=str, default='',
                        help='file_name.')
    args = parser.parse_args()
    main(args)
    #python client.py -m ecb -e 0 --port 5959 --addr 127.0.0.1 -f Jungkook.jpg